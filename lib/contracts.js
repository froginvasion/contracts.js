...
(function() {
  ...
  */
  ...
  overload_fun = function(contractParents, blameparents) {
    var args, blameOrThrow, c, cname, f, funs, getCalldom, getCallrng, i, isCheck, isDelayedContract, isFun, isObject, _i, _len;
    ...
    c = new Contract(cname, "overloaded_fun", function(f, pos, neg, parentKs, stack) {
      var e, handler, localfuns, makeHandler, p, parents;
