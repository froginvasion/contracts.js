  ...
  */
      ...
      */
      ...
      makeHandler = function(dom, rng, options) {
        ...
        return functionHandler = function() {
          var args, bf, boundArgs, checked, clean_rng, dep_args, e, i, isrest, max_i, res, thisc, _ref, _ref1;
          args = [];
          ...
          if (typeof (dom != null ? dom.length : void 0) === 'number') {
            if (arguments.length > dom.length && !options.rest) {
          ...
          while (i < max_i) {
            if (isrest) {
              ...
              if (((_ref1 = dom[i]) != null ? _ref1.ctype : void 0) === "opt" && arguments[i] !== void 0 && (options.rest != null)) {
                try {
  ...
  object = function(objContract, options, name) {
    ...
    c = new Contract(objName(objContract), "object", function(obj, pos, neg, parentKs) {
      var contractDesc, e, handler, invariant, newobj, nonObject, objDesc, op, parents, prop, proto, that, val, value, _ref, _ref1;
      ...
      handler["get"] = function(receiver, name) {
        if (that.oc.hasOwnProperty(name)) {
          ...
          return obj && options.stringIndexContract.check(obj[name], pos, neg, parents);
        } else if (options.numberIndexContract && (typeof name === "number")) {
          return obj && options.numberIndexContract.check(obj[name], pos, neg, parents);
        } else {
          return obj && obj[name];
        }
      };
