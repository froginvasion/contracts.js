...
(function() {
  ...
  */
  ...
  var Contract, ModuleName, Unproxy, Utils, and_, any, arr, blame, blameM, check, checkOptions, contract_orig_map, ctor, ctorSafe, enabled, extend, findCallsite, fun, getModName, guard, idHandler, none, not_, object, opt, or_, overload_fun, root, self, show_parent_contracts, unproxy, ___, _blame,
          ...
          for (_l = 0, _len3 = rngcontracts.length; _l < _len3; _l++) {
            ...
            try {
              if (isDelayedContract(rngcontract.contract)) {
                if (!(domcontract.contract.ctype === "opt" && current_arg === void 0)) {
