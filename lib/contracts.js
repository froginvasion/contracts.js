  ...
  overload_fun = function(contractParents, blameparents) {
    ...
    c = new Contract(cname, "overloaded_fun", function(f, pos, neg, parentKs, stack) {
      ...
      makeHandler = function(target, thisArg, args) {
        var cb, current_arg, delayed_ks, delayed_rng, domcontract, domcontracts, e, errors, idx, max_i, newK, new_arguments, p, res, rngcontract, rngcontracts, _j, _k, _len1, _len2;
        if (args === void 0) {
          args = thisArg;
        }
        localfuns = funs.slice(0);
        ...
        while (i < max_i) {
          ...
          for (_j = 0, _len1 = domcontracts.length; _j < _len1; _j++) {
            domcontract = domcontracts[_j];
            try {
        ...
        for (_k = 0, _len2 = rngcontracts.length; _k < _len2; _k++) {
          rngcontract = rngcontracts[_k];
          try {
