...
(function() {
  ...
  */
  ...
  overload_fun = function() {
    var args, c, cname, f, funs, getCalldom, getCallrng, i, remove, _i, _len;
    ...
    c = new Contract(cname, "overloaded_fun", function(f, name, pos, neg, parentKs, stack) {
      var handler, localfuns, p, parents;
      localfuns = funs.slice(0);
      parents = parentKs.slice(0);
      handler = {};
      handler["apply"] = function(target, thisArg, args) {
        var arg, callres, current_arg, domcontract, e, errors, key, max_i, res, rngcontract, rngres, _j, _k, _len1, _len2, _ref, _ref1;
        localfuns = funs.slice(0);
        errors = [];
        i = 0;
        max_i = args.length;
        while (i < max_i) {
          res = [];
          current_arg = args[i];
          _ref = getCalldom.call(localfuns, i);
          for (key = _j = 0, _len1 = _ref.length; _j < _len1; key = ++_j) {
            domcontract = _ref[key];
            try {
        ...
        callres = [];
        _ref1 = getCallrng.call(localfuns);
        for (key = _k = 0, _len2 = _ref1.length; _k < _len2; key = ++_k) {
          rngcontract = _ref1[key];
          try {
