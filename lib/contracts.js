...
(function() {
  ...
  */
  ...
  var Coffer, Contract, ModuleName, Unproxy, Utils, and_, any, arr, blame, blameM, check, checkOptions, contract_orig_map, ctor, ctorSafe, enabled, extend, findCallsite, fun, generic_object, generic_var, getModName, guard, idHandler, infer_primitive, none, not_, object, opt, or_, overload_fun, root, self, show_parent_contracts, unproxy, ___, _blame,
  ...
  overload_fun = function(contractParents, blameparents) {
    ...
    c = new Contract(cname, "overloaded_fun", function(f, pos, neg, parentKs, stack) {
      ...
      handler["defineProperty"] = function(name, desc) {
        ...
        if (ocs.length === 0) {
          return Object.defineProperty(f, name, desc);
        }
      ...
      handler["delete"] = function(name) {
        var e, key, oc, ocproxy, ocs, res, _j, _len1;
        localfuns = funs.slice(0);
        ocs = getObjectContracts.call(localfuns);
        if (ocs.length === 0) {
          if (ocs.length === 0) {
