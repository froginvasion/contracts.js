...
(function() {
  ...
  */
  ...
  var Contract, ModuleName, Unproxy, Utils, and_, any, arr, blame, blameM, check, checkOptions, contract_orig_map, ctor, ctorSafe, enabled, extend, findCallsite, fun, generic_contract, generic_object, getModName, guard, idHandler, none, not_, object, opt, or_, overload_fun, root, self, show_parent_contracts, unproxy, ___, _blame,
  ...
  generic_contract = function(name) {
    var c, handler;
  ...
  object = function(objContract, options, name) {
    ...
    c = new Contract(objName(objContract), "object", function(obj, pos, neg, parentKs) {
      ...
      if (this.oc["prototype"] !== void 0) {
        ...
        this.oc["prototype"] = options["class"];
      }
      _ref1 = this.oc;
      for (prop in _ref1) {
