...
(function() {
  ...
  */
  ...
  overload_fun = function(contractParents, blameparents) {
    ...
    while (i < args.length) {
      c = args[i];
      if (!c instanceof Contract || c.ctype !== "fun") {
    ...
    c = new Contract(cname, "overloaded_fun", function(f, pos, neg, parentKs, stack) {
      var handler, localfuns, makeHandler, p, parents;
      localfuns = funs.slice(0);
      parents = parentKs.slice(0);
      handler = {};
      makeHandler = function(target, thisArg, args) {
        var cb, current_arg, delayed_ks, delayed_rng, domcontract, domcontracts, e, errors, idx, k, max_i, newK, new_arguments, p, res, rngcontract, rngcontracts, _j, _k, _l, _len1, _len2, _len3, _ref;
        if (args === void 0) {
          args = thisArg;
        }
        localfuns = funs.slice(0);
        ...
        for (k = _j = 0, _len1 = localfuns.length; _j < _len1; k = ++_j) {
          f = localfuns[k];
          if (args.length > ((_ref = f.calldom) != null ? _ref.length : void 0)) {
            delete localfuns[k];
          }
        }
      ...
      handler["apply"] = function(target, thisArg, args) {
        return makeHandler(target, thisArg, args);
      };
      handler["construct"] = function(target, args) {
        return makeHandler(target, args);
      };
      p = Proxy(f, handler);
      unproxy.set(p, this);
      return p;
